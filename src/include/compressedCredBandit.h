...
WINBASEAPI WINBOOL WINAPI CABINET$CreateCompressor(DWORD Algorithm, PCOMPRESS_ALLOCATION_ROUTINES AllocationRoutines, PCOMPRESSOR_HANDLE CompressorHandle);
WINBASEAPI WINBOOL WINAPI CABINET$Compress (COMPRESSOR_HANDLE CompressorHandle, PVOID UncompressedData, SIZE_T UncompressedDataSize, PVOID CompressedBuffer, SIZE_T CompressedBufferSize, PSIZE_T CompressedDataSize);
WINBASEAPI WINBOOL WINAPI CABINET$CloseDecompressor (DECOMPRESSOR_HANDLE DecompressorHandle);
